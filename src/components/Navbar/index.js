      ...
      <Container className="header">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto" defaultActiveKey="#home">
            ...
            <Nav.Item>
              <Nav.Link href="#sobre" onClick={() => updateExpanded(false)}>
              Sobre
              </Nav.Link>
            </Nav.Item>
            ...
            <Nav.Item>
              ...
              <Nav.Item>
              <Nav.Link href="#footer" onClick={() => updateExpanded(false)}>
              Contato
              </Nav.Link>
            </Nav.Item>
          </Nav>
